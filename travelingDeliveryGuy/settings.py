"""
Django settings for travelingDeliveryGuy project.
...
SECRET_KEY = 's_7uh%fw90)_nafkh@mwuyfjst6pf-#0_$!_#pow-1dbyug-g-'
...
ROOT_URLCONF = 'travelingDeliveryGuy.urls'
...
WSGI_APPLICATION = 'travelingDeliveryGuy.wsgi.application'
